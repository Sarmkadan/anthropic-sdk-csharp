...
public sealed class MessageService : global::Anthropic.Client.Services.Beta.IMessageService
{
    public global::Anthropic.Client.Services.Beta.IMessageService WithOptions(
        Func<ClientOptions, ClientOptions> modifier
    )
    {
        return new global::Anthropic.Client.Services.Beta.MessageService(
