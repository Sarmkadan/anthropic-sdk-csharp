...
public sealed class ModelService : global::Anthropic.Client.Services.Beta.IModelService
{
    public global::Anthropic.Client.Services.Beta.IModelService WithOptions(
        Func<ClientOptions, ClientOptions> modifier
    )
    {
        return new global::Anthropic.Client.Services.Beta.ModelService(
