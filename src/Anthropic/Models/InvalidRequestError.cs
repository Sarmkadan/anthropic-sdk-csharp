...
using InvalidRequestErrorProperties = Anthropic.Models.InvalidRequestErrorProperties;
        ...
        Anthropic::IFromRaw<InvalidRequestError>
{
    ...
    public required InvalidRequestErrorProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<InvalidRequestErrorProperties::Type>(element)
