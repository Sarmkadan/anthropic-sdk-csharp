...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<OverloadedError>))]
public sealed record class OverloadedError
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<OverloadedError>
{
...
#pragma warning disable CS8618
    ...
    OverloadedError(Generic::Dictionary<string, Json::JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static OverloadedError FromRawUnchecked(
