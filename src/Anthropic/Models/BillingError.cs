...
using BillingErrorProperties = Anthropic.Models.BillingErrorProperties;
...
public sealed record class BillingError : Anthropic::ModelBase, Anthropic::IFromRaw<BillingError>
{
    ...
    public required BillingErrorProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BillingErrorProperties::Type>(element)
