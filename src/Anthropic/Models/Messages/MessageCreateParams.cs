...
public sealed record class MessageCreateParams : Anthropic::ParamsBase
{
    ...
    public Metadata? Metadata
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Metadata?>(element);
        }
    ...
    /// </summary>
    public Generic::List<ToolUnion>? Tools
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<ToolUnion>?>(element);
        }
