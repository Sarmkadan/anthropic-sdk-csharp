...
using CitationsWebSearchResultLocationProperties = Anthropic.Models.Messages.CitationsWebSearchResultLocationProperties;
...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<CitationsWebSearchResultLocation>))]
public sealed record class CitationsWebSearchResultLocation
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<CitationsWebSearchResultLocation>
{
    ...
    public required CitationsWebSearchResultLocationProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<CitationsWebSearchResultLocationProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    CitationsWebSearchResultLocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
