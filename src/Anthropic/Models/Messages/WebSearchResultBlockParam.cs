...
using System = System;
using WebSearchResultBlockParamProperties = Anthropic.Models.Messages.WebSearchResultBlockParamProperties;

namespace Anthropic.Models.Messages;

[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<WebSearchResultBlockParam>))]
public sealed record class WebSearchResultBlockParam
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<WebSearchResultBlockParam>
{
    ...
    public required WebSearchResultBlockParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<WebSearchResultBlockParamProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    WebSearchResultBlockParam(Generic::Dictionary<string, Json::JsonElement> properties)
    {
