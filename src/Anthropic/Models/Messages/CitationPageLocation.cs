...
using CitationPageLocationProperties = Anthropic.Models.Messages.CitationPageLocationProperties;
...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<CitationPageLocation>))]
public sealed record class CitationPageLocation
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<CitationPageLocation>
{
    ...
    public required CitationPageLocationProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<CitationPageLocationProperties::Type>(element)
...
#pragma warning disable CS8618
    ...
    CitationPageLocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
