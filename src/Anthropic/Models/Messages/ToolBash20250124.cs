...
using System = System;
using ToolBash20250124Properties = Anthropic.Models.Messages.ToolBash20250124Properties;
        ...
        Anthropic::IFromRaw<ToolBash20250124>
{
    ...
    /// </summary>
    public required ToolBash20250124Properties::Name Name
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ToolBash20250124Properties::Name>(element)
                ?? throw new System::ArgumentNullException("name");
        }
        set { this.Properties["name"] = Json::JsonSerializer.SerializeToElement(value); }
    }

    public required ToolBash20250124Properties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<ToolBash20250124Properties::Type>(element)
