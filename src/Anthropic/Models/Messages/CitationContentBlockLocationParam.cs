...
using CitationContentBlockLocationParamProperties = Anthropic.Models.Messages.CitationContentBlockLocationParamProperties;
        ...
        Anthropic::IFromRaw<CitationContentBlockLocationParam>
{
    ...
    public required CitationContentBlockLocationParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<CitationContentBlockLocationParamProperties::Type>(
                    element
