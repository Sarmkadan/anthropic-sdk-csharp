...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaInvalidRequestError>))]
public sealed record class BetaInvalidRequestError
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaInvalidRequestError>
{
...
#pragma warning disable CS8618
    ...
    BetaInvalidRequestError(Generic::Dictionary<string, Json::JsonElement> properties)
    {
