...
using BetaCodeExecutionOutputBlockProperties = Anthropic.Models.Beta.Messages.BetaCodeExecutionOutputBlockProperties;
        ...
        Anthropic::IFromRaw<BetaCodeExecutionOutputBlock>
{
    ...
    public required BetaCodeExecutionOutputBlockProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionOutputBlockProperties::Type>(
                    element
