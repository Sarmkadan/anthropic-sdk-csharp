...
using BetaCitationCharLocationProperties = Anthropic.Models.Beta.Messages.BetaCitationCharLocationProperties;
        ...
        Anthropic::IFromRaw<BetaCitationCharLocation>
{
    ...
    public required BetaCitationCharLocationProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCitationCharLocationProperties::Type>(
                    element
