...
using BetaCodeExecutionToolResultBlockParamProperties = Anthropic.Models.Beta.Messages.BetaCodeExecutionToolResultBlockParamProperties;
...
[Serialization::JsonConverter(
    typeof(Anthropic::ModelConverter<BetaCodeExecutionToolResultBlockParam>)
)]
public sealed record class BetaCodeExecutionToolResultBlockParam
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaCodeExecutionToolResultBlockParam>
{
    public required BetaCodeExecutionToolResultBlockParamContent Content
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionToolResultBlockParamContent>(
                    element
    ...
    public required BetaCodeExecutionToolResultBlockParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionToolResultBlockParamProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaCodeExecutionToolResultBlockParam(Generic::Dictionary<string, Json::JsonElement> properties)
    {
