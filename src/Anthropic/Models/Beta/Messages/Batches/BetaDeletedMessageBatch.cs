...
using BetaDeletedMessageBatchProperties = Anthropic.Models.Beta.Messages.Batches.BetaDeletedMessageBatchProperties;
        ...
        Anthropic::IFromRaw<BetaDeletedMessageBatch>
{
    ...
    /// </summary>
    public required BetaDeletedMessageBatchProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaDeletedMessageBatchProperties::Type>(
                    element
