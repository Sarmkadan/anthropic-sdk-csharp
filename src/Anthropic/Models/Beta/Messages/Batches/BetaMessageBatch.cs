...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaMessageBatch>))]
        ...
        Anthropic::IFromRaw<BetaMessageBatch>
{
    ...
    public required BetaMessageBatchProperties::ProcessingStatus ProcessingStatus
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaMessageBatchProperties::ProcessingStatus>(
                    element
    ...
    public required BetaMessageBatchRequestCounts RequestCounts
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaMessageBatchRequestCounts>(element)
...
#pragma warning disable CS8618
    ...
    BetaMessageBatch(Generic::Dictionary<string, Json::JsonElement> properties)
    {
