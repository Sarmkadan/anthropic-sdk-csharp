...
using BetaCodeExecutionResultBlockProperties = Anthropic.Models.Beta.Messages.BetaCodeExecutionResultBlockProperties;
...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaCodeExecutionResultBlock>))]
public sealed record class BetaCodeExecutionResultBlock
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaCodeExecutionResultBlock>
{
    public required Generic::List<BetaCodeExecutionOutputBlock> Content
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<Generic::List<BetaCodeExecutionOutputBlock>>(
                    element
    ...
    public required BetaCodeExecutionResultBlockProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionResultBlockProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaCodeExecutionResultBlock(Generic::Dictionary<string, Json::JsonElement> properties)
    {
