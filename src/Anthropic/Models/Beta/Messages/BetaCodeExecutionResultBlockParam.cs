...
using BetaCodeExecutionResultBlockParamProperties = Anthropic.Models.Beta.Messages.BetaCodeExecutionResultBlockParamProperties;
        ...
        Anthropic::IFromRaw<BetaCodeExecutionResultBlockParam>
{
    ...
    public required BetaCodeExecutionResultBlockParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionResultBlockParamProperties::Type>(
                    element
