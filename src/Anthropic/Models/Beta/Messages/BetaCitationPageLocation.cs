...
using BetaCitationPageLocationProperties = Anthropic.Models.Beta.Messages.BetaCitationPageLocationProperties;
        ...
        Anthropic::IFromRaw<BetaCitationPageLocation>
{
    ...
    public required BetaCitationPageLocationProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCitationPageLocationProperties::Type>(
                    element
