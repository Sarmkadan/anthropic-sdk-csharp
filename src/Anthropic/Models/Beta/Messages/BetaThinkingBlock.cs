...
using BetaThinkingBlockProperties = Anthropic.Models.Beta.Messages.BetaThinkingBlockProperties;
        ...
        Anthropic::IFromRaw<BetaThinkingBlock>
{
    ...
    public required BetaThinkingBlockProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaThinkingBlockProperties::Type>(element)
