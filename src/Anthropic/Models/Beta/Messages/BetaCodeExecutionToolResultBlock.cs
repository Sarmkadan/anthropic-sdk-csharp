...
using BetaCodeExecutionToolResultBlockProperties = Anthropic.Models.Beta.Messages.BetaCodeExecutionToolResultBlockProperties;
        ...
        Anthropic::IFromRaw<BetaCodeExecutionToolResultBlock>
{
    ...
    public required BetaCodeExecutionToolResultBlockProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionToolResultBlockProperties::Type>(
                    element
