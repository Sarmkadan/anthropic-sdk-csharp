...
using BetaWebSearchResultBlockProperties = Anthropic.Models.Beta.Messages.BetaWebSearchResultBlockProperties;
...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaWebSearchResultBlock>))]
public sealed record class BetaWebSearchResultBlock
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaWebSearchResultBlock>
{
    ...
    public required BetaWebSearchResultBlockProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaWebSearchResultBlockProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaWebSearchResultBlock(Generic::Dictionary<string, Json::JsonElement> properties)
    {
