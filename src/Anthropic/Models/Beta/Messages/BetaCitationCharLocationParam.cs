...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaCitationCharLocationParam>))]
public sealed record class BetaCitationCharLocationParam
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaCitationCharLocationParam>
{
    ...
    public required BetaCitationCharLocationParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCitationCharLocationParamProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaCitationCharLocationParam(Generic::Dictionary<string, Json::JsonElement> properties)
    {
