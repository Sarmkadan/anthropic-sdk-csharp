...
using BetaCitationContentBlockLocationProperties = Anthropic.Models.Beta.Messages.BetaCitationContentBlockLocationProperties;
...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaCitationContentBlockLocation>))]
public sealed record class BetaCitationContentBlockLocation
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaCitationContentBlockLocation>
{
    ...
    public required BetaCitationContentBlockLocationProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCitationContentBlockLocationProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaCitationContentBlockLocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
