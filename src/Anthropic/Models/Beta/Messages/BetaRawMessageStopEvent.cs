...
using BetaRawMessageStopEventProperties = Anthropic.Models.Beta.Messages.BetaRawMessageStopEventProperties;
...
{
    public required BetaRawMessageStopEventProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaRawMessageStopEventProperties::Type>(
                    element
