...
using BetaCitationsWebSearchResultLocationProperties = Anthropic.Models.Beta.Messages.BetaCitationsWebSearchResultLocationProperties;
...
[Serialization::JsonConverter(
    typeof(Anthropic::ModelConverter<BetaCitationsWebSearchResultLocation>)
)]
public sealed record class BetaCitationsWebSearchResultLocation
    : Anthropic::ModelBase,
        Anthropic::IFromRaw<BetaCitationsWebSearchResultLocation>
{
    ...
    public required BetaCitationsWebSearchResultLocationProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCitationsWebSearchResultLocationProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaCitationsWebSearchResultLocation(Generic::Dictionary<string, Json::JsonElement> properties)
    {
