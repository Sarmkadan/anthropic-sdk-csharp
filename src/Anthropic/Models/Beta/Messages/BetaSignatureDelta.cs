...
using BetaSignatureDeltaProperties = Anthropic.Models.Beta.Messages.BetaSignatureDeltaProperties;
        ...
        Anthropic::IFromRaw<BetaSignatureDelta>
{
    ...
    public required BetaSignatureDeltaProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaSignatureDeltaProperties::Type>(element)
