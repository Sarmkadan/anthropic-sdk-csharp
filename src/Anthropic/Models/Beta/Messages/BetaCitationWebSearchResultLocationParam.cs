...
using BetaCitationWebSearchResultLocationParamProperties = Anthropic.Models.Beta.Messages.BetaCitationWebSearchResultLocationParamProperties;
        ...
        Anthropic::IFromRaw<BetaCitationWebSearchResultLocationParam>
{
    ...
    public required BetaCitationWebSearchResultLocationParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCitationWebSearchResultLocationParamProperties::Type>(
                    element
