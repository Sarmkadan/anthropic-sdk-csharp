...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaCodeExecutionToolResultError>))]
        ...
        Anthropic::IFromRaw<BetaCodeExecutionToolResultError>
{
    public required BetaCodeExecutionToolResultErrorCode ErrorCode
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaCodeExecutionToolResultErrorCode>(element)
...
#pragma warning disable CS8618
    ...
    BetaCodeExecutionToolResultError(Generic::Dictionary<string, Json::JsonElement> properties)
    {
