...
using BetaMCPToolUseBlockParamProperties = Anthropic.Models.Beta.Messages.BetaMCPToolUseBlockParamProperties;
...
[Serialization::JsonConverter(typeof(Anthropic::ModelConverter<BetaMCPToolUseBlockParam>))]
        ...
        Anthropic::IFromRaw<BetaMCPToolUseBlockParam>
{
    ...
    public required BetaMCPToolUseBlockParamProperties::Type Type
    {
        get
        {
            ...
            return Json::JsonSerializer.Deserialize<BetaMCPToolUseBlockParamProperties::Type>(
                    element
...
#pragma warning disable CS8618
    ...
    BetaMCPToolUseBlockParam(Generic::Dictionary<string, Json::JsonElement> properties)
    {
